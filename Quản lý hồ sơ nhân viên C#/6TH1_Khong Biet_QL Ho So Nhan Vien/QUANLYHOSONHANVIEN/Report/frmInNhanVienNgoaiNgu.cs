...
{
    public partial class frmInNhanVienNgoaiNgu : DevComponents.DotNetBar.Office2007Form
    {
        public frmInNhanVienNgoaiNgu()
        {
            InitializeComponent();
        }
        ...
        public frmInNhanVienNgoaiNgu(string str)
            : this()
        {
            maNN = str;
           // MessageBox.Show(maNN);
        }

        private void frmInNhanVienNgoaiNgu_Load(object sender, EventArgs e)
        {
