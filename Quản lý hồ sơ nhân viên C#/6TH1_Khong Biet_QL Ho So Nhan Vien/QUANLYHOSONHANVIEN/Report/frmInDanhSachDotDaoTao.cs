...
{
    public partial class frmInDanhSachDotDaoTao : DevComponents.DotNetBar.Office2007Form
    {
        public frmInDanhSachDotDaoTao()
        {
            InitializeComponent();
        }
        string maDDT;
        CRDanhSachDotDaoTao rpt = new CRDanhSachDotDaoTao();
        public frmInDanhSachDotDaoTao(string str):this()
        {
            maDDT = str;
        }

        private void frmInDanhSachDotDaoTao_Load(object sender, EventArgs e)
        {
            ThongTinCongTyInfo congty = ThamSo.LayTTCongTy();
            Connect();
            rpt.SetParameterValue("paraMaDDT", maDDT);
