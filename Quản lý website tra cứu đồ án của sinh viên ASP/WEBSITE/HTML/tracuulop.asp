...
<td valign=top>
      <!--#include file="ketnoi.inc"-->
<form action=tclop.asp method=post>
<%
 sql="select distinct tenlop from dsdtlop"
 set rs = cn.execute(sql)
    if  not rs.eof then %>
	
<p align="center"><b><font size="4">TRA CỨU ĐỀ TÀI THEO LỚP</font></b></p>
	
<table border="0" width="60%">
	<tr>
		<td width="380">
		<p align="center">Tên lớp</td>
		<td>
