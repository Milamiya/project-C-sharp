...
<table>
<td valign=top width=210> 	<img src="HINH%20ANH/anh9.gif" width="70%" height=120>
...
<td valign=top>
<!--#include file="ketnoi.inc"-->
<form action=tccn.asp method=post>
<%
 sql="select distinct ID_chuyennganh,tenchuyennganh from dsdtcn2"
 set rs = cn.execute(sql)
    if  not rs.eof then %>
	
<p align="center"><b><font size="4">TRA CỨU ĐỀ TÀI THEO CHUYÊN NGÀNH</font></b></p>
	
<table border="0" width="100%">
	<tr>
		<td width="380">
		<p align="center">Tên chuyên ngành</td>
		<td>
		<p align="center"><select name=tl size=1>
	<%do while not rs.eof%>
	...
	<tr>
		...
		<td width="380">
		<p align="center">
		<input type="submit" value="Tra cứu" style="float: right"></td>
	</tr>
</table>
</form>
</td>
