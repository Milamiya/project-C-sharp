<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucStudents.ascx.cs" Inherits="TestOnline.hy.vn.Control.Manager.ucStudents" %>
<style type="text/css">
    .Sj_Khung
    {
        width: 974px;
...
<div class="Sj_Khung">
    ...
    <div style="margin: 5px 10px 5px 5px; width:960px">
        <asp:GridView ID="grvStudent" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            onrowcommand="grvStudent_RowCommand" onrowcreated="grvStudent_RowCreated" 
            onrowdatabound="grvStudent_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="StudentName" HeaderText="Tên thành viên" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
                    <HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
                ...
                <asp:BoundField DataField="Nativevilage" HeaderText="Nativevilage" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
                    <HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="RegistrationDate" HeaderText="Ngày đăng ký" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
                    <HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
                <asp:TemplateField HeaderStyle-Width="30px" HeaderText="Xóa">
                    <ItemTemplate>
                        <asp:LinkButton ID="btnXoa" runat="server" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"StudentID")%>'
