<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucThread.ascx.cs" Inherits="TestOnline.hy.vn.Control.Manager.ucThread" %>
<style type="text/css">
    .Sj_Khung
    {
        width: 974px;
...
<div class="Sj_Khung">
    ...
    <div style="width: 1000px; margin-top: 10px">
        ...
        <div style="float:left">
            <asp:TextBox ID="txtMaxScores" Width="300px" 
                runat="server">1000</asp:TextBox></div>
    </div>
    <br />
     <div style="width: 1000px; margin-top: 10px">
       <div class="ucDepartment_lable">
           Hình thức:(*)</div>
        <div class="ucDepartment_text">
          <asp:DropDownList runat="server" ID="ddlStatus" Width="305px">
    ...
    <br />
       <div style="width: 1000px; margin-top: 10px">
        <div class="ucDepartment_lable">
           Số câu hỏi:(*)</div>
        <div class="ucDepartment_text">
            <asp:TextBox ID="txtNumberQuestion" Width="300px" runat="server">50</asp:TextBox></div>
            
        <div class="ucDepartment_lable">
            Mức độ:(*)</div>
        <div class="ucDepartment_text">
           <asp:DropDownList runat="server" ID="ddlLevel" Width="305" AutoPostBack="True" 
                onselectedindexchanged="ddlLevel_SelectedIndexChanged"></asp:DropDownList></div>
    </div>
    <br />
       <div style="width: 1000px; margin-top: 10px">
           ...
           Ngày thi:(*)</div>
        <div class="ucDepartment_text">
            <asp:DropDownList runat="server" ID="ddlDate" Width="95"></asp:DropDownList>   <asp:DropDownList runat="server" ID="ddlMonth" Width="95"></asp:DropDownList>   <asp:DropDownList runat="server" ID="ddlYear" Width="95"></asp:DropDownList>
          </div>
        <div class="ucDepartment_lable">
            Giờ bắt đầu:</div>
        <div class="ucDepartment_text">
           <asp:TextBox runat="server" Width="80px" ID="txtHour"></asp:TextBox>&nbsp h &nbsp phút bắt đầu:<asp:TextBox runat="server" Width="80px" ID="txtMimute"></asp:TextBox>&nbsp p
           </div>
    </div>
    <br />
    <br />
    ...
    <div style="margin: 5px 10px 5px 5px; width:960px">
        <asp:GridView ID="grvThread" runat="server" Width="100%" AutoGenerateColumns="False"
            AllowPaging="True" CellPadding="0" ForeColor="#333333" 
            onpageindexchanging="grvThread_PageIndexChanging" 
            onrowcommand="grvThread_RowCommand" onrowcreated="grvThread_RowCreated" 
            onrowdatabound="grvThread_RowDataBound" onrowdeleting="grvThread_RowDeleting" 
            onrowediting="grvThread_RowEditing">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Level" HeaderText="Mức độ" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
                    <HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
                ...
                <asp:BoundField DataField="DateTest" HeaderText="Ngày thi" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
                    <HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="Hour" HeaderText="Giờ thi"  HeaderStyle-CssClass="ucDepartment_gridview_Center"/>
                <asp:BoundField DataField="Minute" HeaderText="Phút"  HeaderStyle-CssClass="ucDepartment_gridview_Center"/>
                <asp:BoundField DataField="Status" HeaderText="Hình thức" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
                    <HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
                <asp:BoundField DataField="NumberQuestions" HeaderText="Số câu hỏi" 
                    HeaderStyle-CssClass="ucDepartment_gridview_Center">
<HeaderStyle CssClass="ucDepartment_gridview_Center"></HeaderStyle>
                </asp:BoundField>
