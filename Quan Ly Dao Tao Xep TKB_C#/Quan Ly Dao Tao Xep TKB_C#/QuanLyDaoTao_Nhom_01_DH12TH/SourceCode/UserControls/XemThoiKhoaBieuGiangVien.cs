    ...
    public partial class XemThoiKhoaBieuGiangVien : UserControl
    {
        public XemThoiKhoaBieuGiangVien()
        {
            try
            {
                ...
                TKBs = new Collection<sp_XemTKBGiangVienResult>();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public string MaGV
        {
            ...
            set
            {
                ...
                {
                    TKBs.Clear();
                    TKBs = ThoiKhoaBieuBUS.GiangVienXemTKB(maGV, ngayDauTuan);
        ...
        /// </summary>
        public Collection<sp_XemTKBGiangVienResult> TKBs;
        ...
        private void ThoiKhoaBieu_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (sp_XemTKBGiangVienResult t in TKBs)
                {
                    Thu th = Thu.Thu2;
                    ...
                    Paint(t.MaPC, t.BuoiHoc, (int)th, t.TietBatDau, t.SoTiet, t.TenMH, t.MaLop, t.MaPhong, 2, t.DiaChi);
                }
                #endregion
            }
            catch (Exception ex)
