...
{
    public partial class frmThemDeNghi : XtraForm
    {
        ...
        private void Set_cmbGiangVien()
        {
            try
            {
                ...
                {
                    deNgiGiangDay1.MaGV = StaticClass.User.TenDangNhap.ToUpper();
                ...
                else//dang nhap bang quyen admin
                {
                    ...
                    deNgiGiangDay1.MaGV = cmbGiangVien.EditValue.ToString();
                }
            }
            catch (Exception ex)
            {
