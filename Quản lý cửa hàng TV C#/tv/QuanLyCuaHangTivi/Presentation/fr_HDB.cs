...
namespace QuanLyCuaHangTivi.Presentation
{
    public partial class fr_HDB : Form
    {
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[4].HeaderText = "Thuế";
            msds.Columns[4].Width = 100;

        }
        public void hienthi()
        {
            string sql = "SELECT     sohdb, manv, ngayban, makhach,thue FROM tb_HDB";
        ...
        private void btluu_Click(object sender, EventArgs e)
        {
            if (themmoi == true)
            {
                try
                {
                    ...
                    ck.MAKHACH = cbncc.Text;
                    ck.THUE = txtthue.Text;
        ...
        private void msds_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtthue.Text = msds.Rows[dong].Cells[4].Value.ToString();
            locktext();
        }
