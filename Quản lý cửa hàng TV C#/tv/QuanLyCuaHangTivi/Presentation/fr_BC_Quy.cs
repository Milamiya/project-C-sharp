...
namespace QuanLyCuaHangTivi.Presentation
{
    public partial class fr_BC_Quy : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "TV Store";
            ...
            sql = @"SELECT     tb_CTHDB.sohdb, SUM(tb_CTHDB.thanhtien) AS TT FROM tb_CTHDB INNER JOIN tb_HDB ON tb_CTHDB.sohdb = tb_HDB.sohdb WHERE tb_HDB.ngayban BETWEEN '" + d1.Text + "' AND '" + d2.Text + "'";
            ...
            exRange.Range["B11:B11"].Value = "Hóa Đơn";
