...
{
    public partial class fr_BC_BCC : Form
    {
        public fr_BC_BCC()
        {
            InitializeComponent();
        ...
        private void fr_BC_BCC_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:E2"].Value = "BÁO CÁO NHÀ CUNG CẤP";
            // Biểu diễn thông tin chung của hóa đơn bán
            sql = @"SELECT     tb_NCC.tenncc, tb_NCC.diachi, tb_NCC.dienthoai, tb_Nhanvien.tennv
FROM         tb_CTHDN INNER JOIN
                      tb_HDN ON tb_CTHDN.sohdn = tb_HDN.sohdn INNER JOIN
                      tb_NCC ON tb_HDN.mancc = tb_NCC.mancc INNER JOIN
                      tb_Nhanvien ON tb_HDN.manv = tb_Nhanvien.manv where tb_NCC.mancc='" + cbncc.Text + "'";
            tblThongtinHD = cn.taobang(sql);
            exRange.Range["B6:C9"].Font.Size = 12;
            exRange.Range["B6:C9"].Font.Name = "Times new roman";
            exRange.Range["B6:B6"].Value = "Tên Nhà Cung Cấp:";
            ...
            sql = @"SELECT     tb_HDN.sohdn, (tb_CTHDN.soluong * tb_CTHDN.dongia + tb_CTHDN.giamgia) AS TT
FROM  tb_CTHDN INNER JOIN  tb_HDN ON tb_CTHDN.sohdn = tb_HDN.sohdn where tb_HDN.mancc='" + cbncc.Text + "'";
            ...
            exRange.Range["B11:B11"].Value = "Số HĐN";
