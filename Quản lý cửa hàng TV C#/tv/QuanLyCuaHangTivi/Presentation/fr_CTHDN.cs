...
namespace QuanLyCuaHangTivi.Presentation
{
    public partial class fr_CTHDN : Form
    {
        ...
        private void btmoi_Click(object sender, EventArgs e)
        {
            ...
            un_locktext();
            setnull();
            string sql = "SELECT sohdn, mativi, soluong, dongia, giamgia, thanhtien FROM tb_CTHDN where sohdn='" + sohdn + "'";
            msds.DataSource = cn.taobang(sql);
            SqlConnection con = cn.getcon();
            con.Open();
            try
        ...
        private void btluu_Click(object sender, EventArgs e)
        {
            if (cbhang.Text != "")
            {
                ...
                string upsl1 = "UPDATE tb_Tivi SET dongianhap ='" + txtdg.Text + "' where mativi ='" + cbhang.Text + "'";
                string upsl2 = "UPDATE tb_Tivi SET dongiaban ='" + gb + "'where mativi='" + cbhang.Text + "'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT     mativi, soluong, dongia, giamgia, thanhtien FROM tb_CTHDN where sohdn='" + cbhd.Text + "'";
