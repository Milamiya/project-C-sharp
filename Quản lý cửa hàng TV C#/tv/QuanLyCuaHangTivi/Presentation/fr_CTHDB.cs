...
namespace QuanLyCuaHangTivi.Presentation
{
    public partial class fr_CTHDB : Form
    {
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[3].HeaderText = "Giảm Giá";
        ...
        public void hienthi()
        {
            string sql = "SELECT sohdb, mativi, soluong, giamgia, thanhtien FROM tb_CTHDB";
        ...
        private void btmoi_Click(object sender, EventArgs e)
        {
            ...
            un_locktext();
            setnull();
            string sql = "SELECT sohdb, mativi, soluong, giamgia, thanhtien FROM tb_CTHDB where sohdb='" + sohdb + "'";
            msds.DataSource = cn.taobang(sql);
            SqlConnection con = cn.getcon();
            con.Open();
            try
        ...
        private void btluu_Click(object sender, EventArgs e)
        {
            if (cbhang.Text != "")
            {
                ...
                string upsl = "UPDATE tb_Tivi SET soluong =soluong - '" + txtsl.Text + "' where mativi='" + cbhang.Text + "'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = @"SELECT     tb_HDB.sohdb,  tb_Khachhang.tenkhach, tb_Khachhang.diachi, tb_Khachhang.dienthoai, 
            ...
            sql = "SELECT     sohdb, mativi, soluong, giamgia, thanhtien FROM tb_CTHDB where sohdb='" + cbhd.Text + "'";
