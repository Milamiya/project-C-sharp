...
{
    public partial class fr_HangSX : Form
    {
        public fr_HangSX()
        {
            InitializeComponent();
        }
        E_tb_HangSX thucthi = new E_tb_HangSX();
        ConnectDB cn = new ConnectDB();
        EC_tb_Hangsx ck = new EC_tb_Hangsx();
        bool themmoi;
        int dong = 0;
        ...
        public void hienthi()
        {
            string sql = "SELECT mahang, tenhang FROM tb_Hangsx";
        ...
        private void fr_Calam_Load(object sender, EventArgs e)
        {
            locktext();
            hienthi();
            khoitaoluoi();
