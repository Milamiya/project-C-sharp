...
{
    public partial class fr_Mau : Form
    {
        public fr_Mau()
        {
            InitializeComponent();
        }
        E_tb_Mau thucthi = new E_tb_Mau();
        ConnectDB cn = new ConnectDB();
        EC_tb_Mau ck = new EC_tb_Mau();
        bool themmoi;
        int dong = 0;
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[0].HeaderText = "Mã Màu";
            msds.Columns[0].Frozen = true;
            msds.Columns[0].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            msds.Columns[0].Width = 100;
            msds.Columns[1].HeaderText = "Tên Màu";
            msds.Columns[1].Width = 300;

        }
        public void hienthi()
        {
            string sql = "SELECT mamau, tenmau FROM tb_Mau";
        ...
        private void fr_Mau_Load(object sender, EventArgs e)
        {
            locktext();
            hienthi();
            khoitaoluoi();
