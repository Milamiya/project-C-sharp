    ...
    class SQL_tb_HDN
    {
        ...
        public void themmoiHDN(EC_tb_HDN hdn)
        {
            cn.ExcuteNonQuery(@"INSERT INTO tb_HDN
                      (sohdn, manv,ngaynhap,mancc) VALUES   (N'" + hdn.SOHDN + "',N'" + hdn.MANV + "',N'" + hdn.NGAYNHAP + "',N'" + hdn.MANCC + "')");
        }
        ...
        public void suaHDN(EC_tb_HDN hdn)
        {
            ...
            SET manv =N'" + hdn.MANV + "',ngaynhap =N'" + hdn.NGAYNHAP + "',mancc =N'" + hdn.MANCC + "' where  sohdn =N'" + hdn.SOHDN + "'");
