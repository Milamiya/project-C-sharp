VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} repDanhSachBenhNhanTheoDiaChi 
   Bindings        =   "DanhSachBenhNhanTheoDiaChi.dsx":0000
   Caption         =   "Danh sach benh nhan can thong ke theo dia chi"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Danh saùch beänh nhaân caàn thoáng keâ laø"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Hoï teân beänh nhaân"
         Alignment       =   2
      EndProperty
      ItemType2       =   3
   ...
   EndProperty
End
Attribute VB_Name = "repDanhSachBenhNhanTheoDiaChi"
