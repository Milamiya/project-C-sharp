...
{
    public class InPhieuThuInfo
    {
        public InPhieuThuInfo()
        {
        }
        ...
        private ChiTietPhatSinhGDInfo m_SoTien;
        public ChiTietPhatSinhGDInfo SoTien
        {
            get { return m_SoTien; }
            set { m_SoTien = value; }
        }
        ...
        private IList<InPhieuThuInfo> m_ChiTiet;

        public IList<InPhieuThuInfo> ChiTiet
        {
