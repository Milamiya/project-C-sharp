...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="doStaffInfo">
        <xsl:for-each select="//nhanvien">
            ...
            <xsl:variable name="staffInfoName">
            ...
            <tr>
                ...
                <td><a href="seeJobInfo.jsp?staffInfoId={$staffInfoId}"><font face="VNI-Times">Coù CV</font></a></td>
                <!--td><a href="passWork.jsp?staffId={$staffInfoId}&#38;staffName={$staffInfoName}"><font face="VNI-Times">Chuyeån Giao</font></a></td-->
            </tr>
        </xsl:for-each>
    </xsl:template>
