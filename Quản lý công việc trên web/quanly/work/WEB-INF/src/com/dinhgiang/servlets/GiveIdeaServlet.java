/**
 * @(#)GiveIdeaServlet.java    v.1.0   2003/07/2
 ...
 */
public class GiveIdeaServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    //HttpSession session = request.getSession(false);
            //Connection conPool = (Connection) request.getAttribute("conJonPool");

	    UploaderBean upload = UploaderBean.getInstance(request);
            String sql = upload.makeInsertSQL("GopY");
            ...
            if (str[0] != null) {
                rowAffected = DBResults.executeUpdate(conPool, str[0]);
            }
            out.println("<html>");
