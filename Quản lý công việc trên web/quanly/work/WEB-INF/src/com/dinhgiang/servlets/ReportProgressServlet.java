/**
 * @(#)ReportProgressServlet.java    v.1.0   2003/07/2
 ...
 * @version 1.0 2 July 2001
 */
public class ReportProgressServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Loi 405 method nay khong chua data phu hop
            //HttpSession session = request.getSession(false);
            //Connection conPool = (Connection) session.getAttribute("conJonPool");
